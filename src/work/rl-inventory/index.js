...
const RlInventory = () => (
  <ScrollToTop>
    ...
    <Content>
      ...
      <Body>
        The motivation for this project was twofold: to build a Firebase app as
        part of a Google Developer Group Toronto Study Jam and to solve a
        personal problem.
      </Body>
      <Body>
        The
      ...
      <Body>
        At the same time, I was facing issues with trading items while playing
        Rocket League on my Nintendo Switch. My item inventory was growing and
        not all the items I had were tradeable - some were trade-locked and some
        I wanted to keep. I wanted a way to get a look at all the items I had
        that I wanted to trade, without having to mentally filter through my
        inventory.
      </Body>
      <Body>
        ...
        {' '}
        came together. I could build a React app to help me input and display my
        items, with Firebase managing the data, all while
        {' '}
        <ExternalLink
          to="https://github.com/andreidobrinski/rocket-league-item-inventory"
          eventLabel="RL repo"
        >
          open sourcing
        </ExternalLink>
      ...
      <Body>
        ...
        more recent addition to their database choices compared to Realtime
        Database, and generally the one that was recommended in the meetup
        group. In Firestore, I decided I would need a single collection,
        {' '}
        <code>Users</code>
        , that would have documents titled with the
        user&apos;s unique ID. Each user only needed one collection,
        {' '}
        <code>Items</code>
      ...
      <Body>
        ...
        <ExternalLink
          ...
          eventLabel="React Reveal from RL"
        >
          React Reveal library
        </ExternalLink>
        {' '}
        while building the front-end. It&apos;s a lightweight animation library
        that let me create subtle let interesting animations in the UI. The
      ...
      <Body>
        ...
        reasonably simple - to an email link, which introduced some challenges.
        One difficulty I faced was with changing between development and
        production environments, since I needed to change code in my project as
        well an in the Firebase console to redirect the email link to the proper
        domain. Switching to using an email link also involved moving some data
        up from a component to a React Context to make sure the browser got data
        from local storage early enough in the tree. The rest of Firebase&apos;s
        API, including Firestore and Hosting, were great to work with. I would
        definitely consider using Firebase again in a personal project or
      ...
      <Body>
        ...
        {' '}
        The plan for now is to use the app myself, share it with friends, and
        post it on social media to see if it can help others having a similar
        issue to mine. From there, I&apos;ll let the feedback and/or the open
        source community to drive any further development of Rocket League Item
        Inventory.
      </Body>
      <BackButton />
    </Content>
